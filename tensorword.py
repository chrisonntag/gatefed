...
# Modifications Copyright 2024 Christoph Sonntag. All Rights Reserved.
#
...
# 
# NOTICE
# This file has been modified. The original file can be found in flwr.server.utils
# The modification adds the possibility to log other metrics as well.
# ==============================================================================
    ...
    def decorator(strategy_class: Strategy) -> Strategy:
        ...
        class TBWrapper(strategy_class):  # type: ignore
            ...
            def evaluate(
                ...
                """Hooks into evaluate for TensorBoard logging purpose."""
                ...
                with writer.as_default(  # pylint: disable=not-context-manager
                    ...
                    for key, value in metrics.items():
                        if type(value) in [int, float]:
                            TF.summary.scalar(f"server/{key}", value, step=server_round)
            ...
            def aggregate_evaluate(
                ...
                with writer.as_default(
                    ...
                    for key, value in metrics_aggregated.items():
                        if type(value) in [int, float]:
                            TF.summary.scalar(f"server/{key}_aggregated", value, step=server_round)
